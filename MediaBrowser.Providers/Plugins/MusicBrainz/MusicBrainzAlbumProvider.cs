...
namespace MediaBrowser.Providers.Music
{
    public class MusicBrainzAlbumProvider : IRemoteMetadataProvider<MusicAlbum, AlbumInfo>, IHasOrder, IDisposable
    {
        ...
        /// <param name="url">Music Brainz URL.</param>
        ...
        private class ReleaseResult
        {
            ...
            private List<ValueTuple<string, string>> artists = new List<ValueTuple<string, string>>();

            public string ReleaseId { get => releaseId; set => releaseId = value; }

            public string ReleaseGroupId { get => releaseGroupId; set => releaseGroupId = value; }
            ...
            public List<(string, string)> Artists { get => artists; set => artists = value; }
